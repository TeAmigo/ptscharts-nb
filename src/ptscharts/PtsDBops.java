...
//      pstmt = DBopspts.setuptradesConnection().prepareStatement(str);
...
//      JOptionPane.showMessageDialog(null, ex.getMessage(), "SQLException", JOptionPane.ERROR_MESSAGE);
//    } finally {
//      return new Instrument(sym, DBopspts.maxExpiryWithDataBySymbol(sym), multiplier,
...
//    try {
//      pstmt =
//              DBopspts.setuptradesConnection(). ////rpc - NOTE:8/15/10 11:35 AM - 22 PARAMS
...
//        pstmt.setString(3, paperTrade.getPosition());
  ...
  public static void main(String[] args) {
    try {
      ...
      con.close();
//      PreparedStatement pstmt1 = PtsDBops.getExpirysForUpdate(con, ul, 20090300, 20100700);
//      PreparedStatement upDateStmt = PtsDBops.updateBeginEndDatesForExpiry(con);
...
//        String bdate = PtsDateOps.dbShortFormatString(lastexp - 5);
//        String edate = PtsDateOps.dbShortFormatString(exp - 6);
